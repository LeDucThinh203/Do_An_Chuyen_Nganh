...
export const createProductSize = async ({ product_id, size_id, warehouse = 0 }) => {
  const [result] = await db.query(
    'INSERT INTO product_sizes (product_id, size_id, warehouse) VALUES (?, ?, ?)',
    [product_id, size_id, warehouse]
  );
